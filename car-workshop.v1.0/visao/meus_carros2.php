...
<!-- Mirrored from seantheme.com/color-admin-v1.8/admin/html/table_manage_combine.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Sep 2015 22:33:21 GMT -->
<head>
	<meta charset="utf-8" />
			...
			<div class="row">
			    ...
			    <div class="col-md-2">
                    ...
                    <ul class="p-l-25 m-b-15">
                        ...
                        <li>KeyTable</li>
                        <li>TableTools</li>
                        <li>Table Data Load from JSON</li>
                    </ul>
                    <p class="m-b-20">
			    ...
			    <div class="col-md-10">
                    <div class="panel panel-inverse">
                        ...
                        <div class="alert alert-warning fade in">
                            ...
                            <i class="fa fa-warning"></i>  The extension for <b class="text-inverse">FixedHeader</b> is not compatible with <b class="text-inverse">Responsive</b> and <b class="text-inverse">Scroller</b>
                        </div>

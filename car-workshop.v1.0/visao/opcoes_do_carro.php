...
<!-- Mirrored from seantheme.com/color-admin-v1.8/admin/html/form_wizards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Sep 2015 22:31:43 GMT -->
<head>
	<meta charset="utf-8" />
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Action S</a></li>
				<li class="active">Wizards</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
                        <h1 class="page-header"><?php echo $_SESSION['id_carro'];?> <small>header small text goes here...</small></h1>
			<!-- end page-header -->
								...
								<div id="wizard">
									<ol>
										<li>
										    ...
										    <small>Visualizar, Editar ou Excluir</small>
										</li>
										<li>
										    Agendar Serviços
										    <small>Revisão, Óleo e Filtro, etc</small>
										</li>
										<li>
										    Histórico de Serviços
										    <small>Consulte serviços ou orçamentos passados</small>
										</li>
										<li>
										    Encomendar uma peça
										    <small></small>
...
<!-- Mirrored from seantheme.com/color-admin-v1.8/admin/html/form_wizards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Sep 2015 22:31:49 GMT -->
</html>
